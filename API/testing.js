...
app.get('/courses/by_code/:course_code', (req, res) =>
{
    ...
    filtered_courses = courseData["courses"].filter(q => q.course_code.includes(query))
...
app.get('/courses/by_title/:title', (req,res) =>
{
    ...
    filtered_courses = courseData["courses"].filter(q => q.title.includes(query))
    let outputJSON = {courses: filtered_courses}
    res.json(outputJSON)
...
app.get('/courses/by_instructor/:instructor', (req,res) =>
{
    ...
    filtered_courses = courseData["courses"].filter(q => q.instructor.includes(query))
    let outputJSON = {courses: filtered_courses}
    res.json(outputJSON)
...
app.get('/courses/by_level/:course_level', (req,res) =>
{
    ...
    filtered_courses = courseData["courses"].filter(q => q.course_level.includes(query))
    let outputJSON = {courses: filtered_courses}
    res.json(outputJSON)
